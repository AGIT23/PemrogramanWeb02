...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-secondary mb-2">
        <a class="navbar-brand" href="#">Informasi Wisata</a>
            ...
            <div class="col-md-6">
                <div class="card card-warning">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <?php for ($i=0; $i < (int) $detail->skor_rating; $i++) { 
                                    echo '<i class="fa fa-star" style="color: #e3e302;"></i>';
                                } ?><br>
                            </div>
                            <div class="col-md-4">
                                <img src="<?= base_url('public/foto/' . $detail->foto1) ?>" class="border d-inline" width="100">
                            </div>
                            <div class="col-md-4">
                                <img src="<?= base_url('public/foto/' . $detail->foto2) ?>" class="border d-inline" width="100">
                            </div>
                            <div class="col-md-4">
                                <img src="<?= base_url('public/foto/' . $detail->foto3) ?>" class="border d-inline" width="100">
                            </div>
                            <div class="col-md-12">
                                <br>
                                <div class="row">
                                    <div class="col-md-1"><i class="fa fa-map-pin"></i></div>
                                    <div class="col-md-11"><?= $detail->alamat ?>, <?= $detail->kecamatan_nama ?>. (<?= $detail->latlong ?>)</div>
                                    ...
                                    <div class="col-md-11"><?=$detail->website?></div>
                                    <div class="col-md-1"><i class="fa fa-building"></i></div>
                                    <div class="col-md-11"><?=$detail->fasilitas?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="nama">Nilai Rating</label>
                            <select name="nilai_rating" id="nilai_rating" class="form-control w-50">
                                <?php foreach ($nilai_rating as $key => $value) : ?>
