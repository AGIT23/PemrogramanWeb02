...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?=$this->session->has_userdata('user') ? $this->session->userdata('user')->username : '-'?></a>
        </div>
      </div>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url("index.php/template/landin")?>">Home</a></li>
  ...
  <footer class="main-footer">
    <strong>Copyright Erasmus;  <a href="#">STT NF</a>.</strong>
    All rights reserved.
