...
<body>
                        ...
                        <div class="about-five-tab">
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button class="nav-link active" id="nav-who-tab" data-bs-toggle="tab" data-bs-target="#nav-who" type="button" role="tab" aria-controls="nav-who" aria-selected="true">VISI</button>
                                    <button class="nav-link" id="nav-vision-tab" data-bs-toggle="tab" data-bs-target="#nav-vision" type="button" role="tab" aria-controls="nav-vision" aria-selected="false">MISI</button>
                                    <button class="nav-link" id="nav-history-tab" data-bs-toggle="tab" data-bs-target="#nav-history" type="button" role="tab" aria-controls="nav-history" aria-selected="false">TUJUAN</button>
                                </div>
                            </nav>
    ...
    <section class="map-section map-style-9">
        <div class="map-container">
            <object style="border:0; height: 400px; width: 100%;" data="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d350.48791576778956!2d106.832546838348!3d-6.352847839571843!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ec6b07b68ea5%3A0x17da46bdf9308386!2sSTT%20Terpadu%20Nurul%20Fikri%20-%20Kampus%20B!5e0!3m2!1sid!2sid!4v1654671609993!5m2!1sid!2sid" referrerpolicy="no-referrer-when-downgrade"></object>
        </div>
        </div>
    </section>
    <!-- ========================= map-section end ========================= -->
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            ...
                            <div class="footer-widget f-about">
                                ...
                                <p class="copyright-text">
                                    ...
                                    <a href="https://www.instagram.com/han_muhmmd12/?hl=id" rel="nofollow"> Muhammad Farhan </a>
                                </p>
                            </div>
                            <!-- End Single Widget -->
                        </div>
