                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">From BMI</h3>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">
                                                <div class="input-group">
                                                    ...
                                                    <input id="name" name="name" placeholder="Masukan Nama Pasien" type="text" class="form-control" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">
                                                <div class="input-group">
                                                    ...
                                                    <input id="berat" name="berat" placeholder="Masukan Berat Badan" type="number" class="form-control" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">
                                                <div class="input-group">
                                                    ...
                                                    <input id="tinggi" name="tinggi" placeholder="Masukan Tinggi Badan" type="number" class="form-control" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body bg-l">
                                    ...
                                    $P3 = new BMIPasien("2022-01-11", "P003", "Lutif", "L", 45.2, 171);

                                    $ar_bmi = [$P1, $P2, $P3];
                                    if (isset($_POST['submit'])) {
                                        $P4 = new BMIPasien($_POST['tanggal'], 'P004', $_POST['name'], $_POST['gender'], $_POST['berat'], $_POST['tinggi']);
